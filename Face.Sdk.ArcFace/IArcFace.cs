...
namespace Face.Sdk.ArcFace
{
    ...
    public interface IArcFace : IDisposable
    {
        ...
        /// <param name="libraryKey">人脸库Key</param>
        /// <returns></returns>
        Task InitFaceLibraryAsync(IEnumerable<FaceData> faces, string libraryKey = "default");
        ...
        /// <param name="libraryKey">人脸库Key</param>
        /// <returns>(是否全部成功,成功记录数)</returns>
        Task<(bool Success, int SuccessCount)> TryInitFaceLibraryAsync(IEnumerable<FaceData> faces,
            string libraryKey = "default");
        ...
        /// <param name="libraryKey">人脸库Key</param>
        /// <returns></returns>
        Task AddFaceAsync(string libraryKey = "default", params FaceData[] faces);
        ...
        /// <param name="libraryKey">人脸库Key</param>
        /// <returns>(是否全部新增成功,新增成功人脸数量)</returns>
        Task<(bool Success, int SuccessCount)> TryAddFaceAsync(string libraryKey = "default", params FaceData[] faces);
        ...
        Task<OperationResult<Recognitions>> SearchFaceAsync(string image, Predicate<FaceData> predicate = null,
            string libraryKey = "default");
        ...
        /// <param name="libraryKey">人脸库Key</param>
        /// <returns>搜索结果</returns>
        Task<OperationResult<Recognitions>> SearchFaceAsync(Stream image, Predicate<FaceData> predicate = null,
            string libraryKey = "default");
        ...
        /// <param name="libraryKey">人脸库Key</param>
        /// <returns>搜索结果</returns>
        Task<OperationResult<Recognitions>> SearchFaceAsync(byte[] feature, Predicate<FaceData> predicate = null,
            string libraryKey = "default");
